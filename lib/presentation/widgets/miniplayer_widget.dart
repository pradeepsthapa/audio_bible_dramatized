...
import 'package:audio_bible_dramarized/presentation/screens/now_playing.dart';
                                        ...
                                        Padding(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: CachedNetworkImage(
                                              ...
                                              placeholder: (context, url) => Image.asset('assets/images/placeholder_1.jpg',fit: BoxFit.cover),
                                              imageUrl: mediaState.mediaItem?.artUri?.toString()??'',
                                              errorWidget: (context, url, error) => Image.asset('assets/images/placeholder_1.jpg',fit: BoxFit.cover),
                                            ),),
                                        ),
                                        Expanded(
                                          child: Padding(
